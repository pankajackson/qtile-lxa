...
class VideoWallpaper:
    ...
    def show(self):
        """Show the widget."""
        if VideoWallpaper.widget_instance:
            return
        ...
        VideoWallpaper.widget_instance = self
    ...
    def hide(self):
        ...
        if self.layout:
            ...
            self.layout.hide()
            self.layout = None
            VideoWallpaper.widget_instance = None


def show_video_wallpaper_widget(qtile):
    if not VideoWallpaper.widget_instance:
        widget = VideoWallpaper(qtile)
        widget.show()
    else:
        VideoWallpaper.widget_instance.hide()
        widget = VideoWallpaper(qtile)
        widget.show()
